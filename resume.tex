...
\cventry{From March 2021}{Software Engineer}{Nonpi}{Tokyo}{}{%
\begin{itemize}%
\setlength\itemsep{1em}
\item Developed a food delivery system for companies
    \begin{itemize}%
        \item Responsibilities:
            \begin{itemize}%
                \item Full-stack development
            \end{itemize}
        \item Technologies used: \techno{Go}, \techno{React}, \techno{MySQL}, \techno{Docker}
    \end{itemize}
\end{itemize}
}
