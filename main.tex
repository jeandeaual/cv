...
\item Developed the backend of an IoT system for the elder care market.
    \begin{itemize}%
        \item Responsibilities:
            \begin{itemize}%
                \item Development of several \lang{Erlang} programs to manage IoT devices;
                \item Creation of a communication API using \techno{AMQP};
                \item Managed a 3 member team;
            \end{itemize}
    ...
    \end{itemize}
% ZMC
\item Designed and developed a management interface for the backend system.
    \begin{itemize}%
        \item Responsibilities:
            \begin{itemize}%
                \item Creation of a REST API using \href{https://aws.amazon.com/api-gateway/}{Amazon API Gateway} and \href{https://aws.amazon.com/lambda/}{AWS Lambda};
            \end{itemize}
        \item Technologies used: \techno{HTTP}, \lang{Java}
    \end{itemize}
\end{itemize}
}
...
\cvitem{Server Side}{\lang{Go}, \lang{Python}, \lang{Ruby}, \lang{Perl}, \lang{Node.js}, \lang{Erlang}}
\cvitem{Client Side}{\lang{JavaScript}, \lang{jQuery}, \lang{HTML5}}
\subsection{Technologies}
\cvitem{Operating Systems}{\techno{RHEL}, \techno{CentOS}, \techno{Debian}, \techno{Ubuntu}, \techno{Windows}}
\cvitem{Database}{\techno{PostgreSQL}, \techno{MySQL}}
% \cvitem{Frameworks}{\techno{RoR}, \techno{Hadoop}}
\cvitem{Mobile}{\techno{Android}}
\cvitem{Testing}{\techno{JUnit}, \techno{PHPUnit}, \techno{Rspec}, \techno{Python unittest}, \techno{Test::More}, \techno{Selenium}}
